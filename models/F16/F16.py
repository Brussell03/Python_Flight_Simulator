...
class F16(DAVEVehicle):
    def __init__(self):
        super().__init__(name="F-16", short_name="F16", aero_dml_path="models/F16/F16_S119_source/F16_aero.dml", inertia_dml_path="models/F16/F16_S119_source/F16_inertia.dml",
